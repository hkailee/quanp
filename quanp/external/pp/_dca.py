...
def dca(
    ...
    normalize_per_suject: bool = True,
    scale: bool = True,
    log1p: bool = True,
    # network args
    ...
    subjects in low dimensions. Type of the autoencoder and return values are
    ...
    mode
        ...
        object. This matrix represent latent representation of subjects via DCA.
    ae_type
    ...
    normalize_per_suject
        If true, library size normalization is performed using
        the `sc.pp.normalize_per_subject` function in Quanpy and saved into adata
        object. Mean layer is re-introduces library size differences by
        scaling the mean value of each subject in the output layer. See the
    ...
    In "latent" mode, latent low dimensional representation of subjects are stored
    ...
    return dca(
        ...
        mode=mode,
        ae_type=ae_type,
        normalize_per_suject=normalize_per_suject,
        scale=scale,
        log1p=log1p,
